                    ...
                    <table class="table table-bordered" >
                        ...
                        <tbody>
                            <?php foreach ($data as $row) {
                                ...
                                <tr>
                                    <td><a href="javascript:void(0)" data-mode="l" data-uid="<?php echo $row->baby_name_id ?>" class="f-20 like-anc" ><i class="fa fa-heart like-plus" aria-hidden="true" title="like"></i></a> <span class="like-count" ><?php echo $row->likes; ?></span>
                                    <a href="javascript:void(0)" data-mode="u" data-uid="<?php echo $row->baby_name_id ?>" class="f-20 like-anc" ><i class="fa fa-heart like-minus" aria-hidden="true" title="undo like"></i></a> <span class="like-count"><?php echo $row->likes; ?></span>
