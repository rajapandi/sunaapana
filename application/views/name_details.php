<section id="home" class="ml-15 pl-10 pr-10  mb-20">
    ...
    <!--a href="" class="v pull-right" data-toggle="tooltip"  style="margin-right:2px;"><i class="fa fa-heart like-plus" style="padding-top: 30px; color:#c00;"  aria-hidden="true" tittle="like"></i></a -->
            ...
            <div class="row" id="mtic">
                ...
                <div class="col-sm-8">
                    <a href="javascript:void(0)" class="p pull-right am-tgg" id="mn-anc" data-toggle="tooltip"  style="margin-right:2px;"><i class="fa fa-pencil text-center" aria-hidden="true"></i></a>
            ...
            <div class="row" id="am">
                <div class="col-sm-12">
                    <a href="#">Add more</a>
                    <p class="text-success" id="am_msg"></p>
                    <div id="am-warp">
                        <input type="text" name="amore" id="amore" class="form-control" placeholder="Add More Information" />
                        <div class="btn-warp pull-right mt-10">
                            <button type="button" class="btn btn-danger am-tgg" id="am-anc-close"><i class="fa fa-remove"></i> Cancel</button>
                            <button type="button" class="btn btn-primary" id="amsb" data-uid="<?php echo $baby_name_id ?>"><i class="fa fa-print"></i> Save</button>
                        </div> 
...
<script>
    ...
    _elt.focus();
            ...
            /* ********************/
            $(document).on('click', '.am-tgg', function () {
    $('#am_msg').empty();
            $('#am-warp').slideToggle(500);
            $('#amore').val('');
            if (!$("#am-warp").is(":hidden"))
    {
    $('#amore').focus();
    }
    });
    ...
    $.ajax({
    type: "POST",
            url: base_url + 'home/admnaddm',
            data: {id: uid, amore: vl},
            dataType: "JSON",
            success: function (data) {

            if (data.rs) {

            $('#am_msg').text('Thanks. We will review this name');
            } else {
            technoNotify('', 'cannot add', 'error');
            }
