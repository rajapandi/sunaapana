...
<section id="home" class="pl-10 pr-10  mb-20">
    ...
    <div class="row">
        ...
        <div class="col-md-5 home-search-wrap">



            <h5 class="widget-title line-bottom">Find Your Babe's Suitable Name</h5>

            <form class="form-horizontal form-lbl-r" id="suitable_fm" action="<?php echo base_url('suitable/find') ?>" method="POST" role="form">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Father's Name <span class="text-danger">*</span></label>
                    <div class="col-md-9">
                        <input type="text" id="father" minlength="2" name="father" class="form-control"  />
                    </div>
                </div>
